 ...
 * UPDATE(apr-2018): Unicode, escape sequences, and everything now supported at the end of this file.
 *
 * Spec:
...
TypeNameExprJsDocFlavored = name:$(JsDocIdentifier) {
                            return {
                              type: NodeType.NAME,
                              name: name
                            };
...
// (BinNumberLiteralExpr / OctNumberLiteralExpr / HexNumberLiteralExpr / DecimalNumberLiteralExpr)
NumberLiteralExpr = value:NumericLiteral {
                    return {
 ...
 * For more information on intersection types, read here:
...
IntersectionTypeExpr = left:IntersectionTypeExprOperand _ "&" _ right:(IntersectionTypeExpr / IntersectionTypeExprOperand) {
                return {
                    ...
                    left: left,
                    right: right,
                    meta: { syntax: IntersectionTypeSyntax.AND },
                };
              }
...
UnionTypeOperatorClosureLibraryFlavored = "|" { return UnionTypeSyntax.PIPE; }

UnionTypeOperatorJSDuckFlavored = "/" { return UnionTypeSyntax.SLASH; }
 ...
 * Examples:
 *   - [string,number]
 *   - [{hello},function(number):string,boolean]
 *
 * Spec:
...
FunctionTypeExprReturnableOperand = PrefixUnaryUnionTypeExpr
                                  ...
                                  // https://github.com/google/closure-compiler/blob/master/src/com/google/javascript/jscomp/parsing/JsDocInfoParser.java#L1507-L1519
                                  / RecordTypeExpr
                                  / FunctionTypeExpr
                                  / ParenthesizedExpr
                                  / ArrayTypeExpr
...
DecimalDigit
  = [0-9] NumericLiteralSeparator [0-9]
  / [0-9]
...
HexIntegerLiteral
  = "0x"i digits:$HexDigit+ {
      return text(); // parseInt(digits, 16);
     }
